...
std::shared_ptr<mumei::Motor> MujocoEnvironment::CreateMotor(
...
std::shared_ptr<mumei::StateProvider> MujocoEnvironment::CreateFloatingBase(
  const std::string& name) {
