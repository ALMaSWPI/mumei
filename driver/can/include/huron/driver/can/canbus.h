...
class CanBusBase {
  public:
    ...
    * empty).
    */
    virtual bool recv_message(can_Message_t& message,
                              uint32_t timeout = UINT32_MAX) = 0;
    ...
    */
    virtual bool subscribe(const MsgIdFilterSpecs& filter,
                           on_can_message_cb_t callback, void* ctx,
                           CanSubscription** handle) = 0;
