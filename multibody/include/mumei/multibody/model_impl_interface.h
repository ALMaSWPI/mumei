...
class ModelImplInterface {
 public:
   ...
   */
  virtual const mumei::Vector6d& GetSpatialMomentum() const;

  /**
   * @brief Get the centroidal momentum.
   */
  virtual mumei::Vector6d GetCentroidalMomentum() const;

  /**
   * @brief Get the centroidal momentum matrix with the cached value.
   */
  virtual const mumei::Matrix6Xd& GetCentroidalMatrix() const;
