...
void Ros2Environment::Initialize(int argc,
  ...
  huron_node_ = std::make_shared<ros2::MumeiNode>();
}
...
std::shared_ptr<mumei::StateProvider> Ros2Environment::CreateJointStateProvider(
...
std::shared_ptr<mumei::ForceTorqueSensor>
...
std::shared_ptr<mumei::MovingInterface>
